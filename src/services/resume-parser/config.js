const llm_config = {
  ...
  prompt: `You are an AI assistant reviewing a CV or resume. Your task is to extract and summarize key information that would help a recruiter or hiring manager quickly understand the candidate's background and achievements.
